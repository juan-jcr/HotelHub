...
const RoomDetailsPage = () => {
  ...
  return (
    <div className="room-details-booking">
      ...
      <br />
      <img src={"http://localhost:8080/upload/"+roomPhotoUrl} alt={roomType} className="room-details-image" />
          ...
          <ul className="booking-list">
            {bookings.map((booking, index) => (
              <li key={booking.id} className="booking-item">
                ...
                <span className="booking-text">Registro: {booking.checkInDate} </span>
                <span className="booking-text">Fuera: {booking.checkOutDate}</span>
              </li>
            ))}
          </ul>
        </div>
      ...
      <div className="booking-info">
        <button className="book-now-button" onClick={() => setShowDatePicker(true)}>Reservar</button>
        ...
        {totalPrice > 0 && (
          <div className="total-price">
            ...
            <p>total de huéspedes: {totalGuests}</p>
            <button onClick={acceptBooking} className="accept-booking">Acceptar reserva</button>
          </div>
        )}
      </div>
    </div>
